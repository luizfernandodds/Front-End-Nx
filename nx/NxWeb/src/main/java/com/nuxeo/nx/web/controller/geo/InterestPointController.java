...
import com.nuxeo.nx.dto.InterestPointDto;
import com.nuxeo.nx.dto.InterestPointTypeDto;
...
@Getter
@Setter
@Named("interestPointController")
@ViewScoped
public class InterestPointController implements Serializable {

	private static final long serialVersionUID = 1L;

	private String namePoint = null;
	private List<InterestPointDto> listInterestPoint = new ArrayList<>();
	private InterestPointDto interestPoint;
	private InterestPointDto selected;
	private InterestPointTypeDto interestPointType = null;
	private List<InterestPointDto> filteredInterestPoint;
...
//	private List<GeocodeOsm> listGeo = null;
	...
	public void clean() {
		...
		if(this.interestPoint!=null) {
			System.out.println("Clean this.protocol.getId(): "+this.interestPoint.getId());
		}
...
//		}
	...
	//	try {
			...
			if (this.interestPoint.getName() != null) {
...
//			}
	...
	public void cancel() {
		...
		this.interestPoint = new InterestPointDto();
