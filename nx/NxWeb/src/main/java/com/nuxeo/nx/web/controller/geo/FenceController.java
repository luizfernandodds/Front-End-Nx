...
import com.nuxeo.nx.dto.FenceDto;
...
@Getter
@Setter
@Named("fenceController")
@ViewScoped
public class FenceController implements Serializable {

	private static final long serialVersionUID = 1L;

	private List<FenceDto> listFence = new ArrayList<>();
	private FenceDto fence;
	private FenceDto selected;
	private List<FenceDto> filteredFence;
	...
	public void clean() {
		...
		if(this.fence!=null) {
			System.out.println("Clean this.protocol.getId(): "+this.fence.getId());
		}
